...
const ImageUpload = ({ files, onUpload, multiple, note }) => {
  ...
  const handleFileUpload = (e) => {
    ...
    console.log("ImageUpload.handleFileUpload newFiles:", newFiles, "current fileList:", fileList);
  ...
  return (
    <div
      className={`file-upload-container animated-border ${isDragging ? "dragging" : ""}`}
